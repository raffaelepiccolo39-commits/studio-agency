    ...
    <>
      ...
      <main>
        ...
        <PageHeader
          tag="CHI SIAMO"
          title="Il partner"
          titleAccent="di riferimento"
          titleAfter="per la tua azienda."
        ...
        {/* Manifesto stile Made in Evolve */}
        <section style={{ borderBottom: '1px solid var(--border)' }}>
          ...
          <div style={{
            ...
            {['Brand Direction', 'Performance Marketing', 'Advanced Tech'].map((label, i) => (
              <div key={i} style={{
          ...
          <div style={{
            ...
            <h2 style={{
              ...
              PIRA WEB NASCE DA UNA VISIONE IMPRENDITORIALE{' '}
            ...
            <div>
              <p style={{
                ...
                color: 'rgba(240,237,230,0.6)', marginBottom: '24px',
              }}>
                Non con un approccio generico alla strategia, controllo operativo
                e orientamento alla performance.
              </p>
              <p style={{
                fontSize: 'clamp(15px,1.6vw,18px)', lineHeight: 1.8,
                color: 'rgba(240,237,230,0.6)', marginBottom: '32px',
              }}>
                Il risultato? Un approccio integrato che ti permette di{' '}
              ...
              <p style={{
                ...
                color: 'var(--muted)', paddingTop: '24px',
