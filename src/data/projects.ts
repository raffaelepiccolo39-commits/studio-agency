...
export const projects: Project[] = [
  ...
  },
  {
    ...
    descrizione: "Azienda storica nel mondo della gioielleria. Per Marietta Capasso abbiamo lavorato su tre livelli: la costruzione di un'identita' visiva all'altezza della tradizione del brand, un logo capace di trasmettere eleganza e artigianalita', e un e-commerce pensato per portare online il valore di ogni pezzo.",
    sfida: "Tradurre in digitale l'anima di un brand storico della gioielleria, mantenendo il prestigio e l'esclusivita' che i clienti si aspettano, senza perdere il calore artigianale che distingue Marietta Capasso.",
    soluzione: "Progettazione del logo e della brand identity completa, seguita dallo sviluppo di un e-commerce su misura che valorizzasse ogni gioiello come merita: con cura del dettaglio visivo, esperienza d'acquisto raffinata e architettura pensata per un pubblico esigente.",
    risultati: [
      { label: 'Logo & Brand', value: 'Creati' },
      { label: 'E-commerce', value: 'Live' },
