  ...
  return (
    <>
      ...
      >
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '94px' }}>
            {/* Big title */}
            <h1 style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '50px' }}>
              ...
              >
                ...
                <div style={{ display: 'flex', gap: 'clamp(20px, 4vw, 60px)', alignItems: 'center' }}>
                  <a href="https://www.instagram.com/piraweb_agency/" target="_blank" rel="noreferrer"
                    style={{ color: '#0a0a0a', display: 'flex' }} aria-label="Instagram">
                    <InstagramIcon />
                  </a>
                  <a href="https://www.facebook.com/pirawebonline" target="_blank" rel="noreferrer"
                    style={{ color: '#0a0a0a', display: 'flex' }} aria-label="Facebook">
                    <FacebookIcon />
                  </a>
                </div>
              </div>
